...
Although the vcf contains very high quality SNPs, ```easysfs``` can not use missing data and we may have to downsample our data to retain the highest number of sites. If ther is lots of missing data or low covergae ANGS can create an SDS and account for genotype uncertanties.
```console
